...
namespace backend.Controllers
{
    ...
    public class UserController : ControllerBase
    {
		...
		VerificationService _validator;
		public UserController(Context _context, ILogger<UserController> logger, IConfiguration configuration, Services.VerificationService validator)
		{
		...
		public async Task<IActionResult> Login(string token)
		{
			...
			try
			{
				internal_token = await JWTIssuer.IssueToken(token, _validator, _logger, _configuration);
