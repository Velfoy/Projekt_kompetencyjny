...
const HistoriaAdmin = () => {
  const rows: RowData[] = [
    ...
    { id: 7, type: "Pokój", item: "p. 09", item_id: "11", unit: "Omega", status: "Zakończona" },
     { id: 8, type: "Pokój", item: "p. 17", item_id: "5", unit: "Voxel", status: "Brak akceptacji" },
    { id: 9, type: "Sala", item: "s. 22", item_id: "6", unit: "Alpha", status: "Zakończona" },
    { id: 10, type: "Pokój", item: "p. 11", item_id: "7", unit: "Beta", status: "W trakcie" },
    { id: 11, type: "Sala", item: "s. 05", item_id: "8", unit: "Gamma", status: "Odrzucona" },
    { id: 12, type: "Pokój", item: "p. 02", item_id: "9", unit: "Delta", status: "Brak akceptacji" },
    { id: 13, type: "Sala", item: "s. 18", item_id: "10", unit: "Sigma", status: "W trakcie" },
    { id: 14, type: "Pokój", item: "p. 09", item_id: "11", unit: "Omega", status: "Zakończona" },
      { id: 1, type: "Pokój", item: "p. 17", item_id: "5", unit: "Voxel", status: "Brak akceptacji" },
    { id: 2, type: "Sala", item: "s. 22", item_id: "6", unit: "Alpha", status: "Zakończona" },
    { id: 3, type: "Pokój", item: "p. 11", item_id: "7", unit: "Beta", status: "W trakcie" },
    { id: 4, type: "Sala", item: "s. 05", item_id: "8", unit: "Gamma", status: "Odrzucona" },
